...
const Contact = () => {
    return (
        <div className="hero min-h-screen bg-base-200" style={{ backgroundImage: 'url(https://i.ibb.co/wwpMd2Y/guy-bianco-iv-oq-PBr7-CSS-g-unsplash.jpg)' }}>
            ...
            <div className="hero-content flex-col glass shadow-xl rounded-lg w-3/6 ">
                <h3 className="text-5xl pt-6 font-extrabold drop-shadow-lg text-center text-yellow-500">Contact Us Now</h3>
                <hr />
